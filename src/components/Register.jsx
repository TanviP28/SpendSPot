...
const Register = ({ switchPage }) => {
  ...
  const handleRegister = async (e) => {
    ...
    try {
      ...
      console.log('User registered:', userCredential.user); // Log the user object
      switchPage('login'); // Switch to login page after registration
    } catch (error) {
...
Register
        ...
        <button onClick={() => switchPage('login')} className="switch-button">Back to Login</button>
      </div>
    </div>
  );
};
